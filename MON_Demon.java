...
public class MON_Demon extends Entity
{
    ...
    public MON_Demon(Panel p)
    {
        ...
        defense = 0;
        exp = 5;
        projectile = new ObjectFireball(p);
    ...
    {
        up1 = setup("/monsters/demonhead1", p.tileSize, p.tileSize);
        up2 = setup("/monsters/demonhead2", p.tileSize, p.tileSize);
        down1 = setup("/monsters/demonhead1", p.tileSize, p.tileSize);
        down2 = setup("/monsters/demonhead2", p.tileSize, p.tileSize);
        left1 = setup("/monsters/demonhead1", p.tileSize, p.tileSize);
        left2 = setup("/monsters/demonhead2", p.tileSize, p.tileSize);
        right1 = setup("/monsters/demonhead1", p.tileSize, p.tileSize);
        right2 = setup("/monsters/demonhead2", p.tileSize, p.tileSize);
