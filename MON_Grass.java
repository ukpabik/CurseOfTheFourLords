...
public class MON_Grass extends Entity
{
    Panel p;
    public MON_Grass(Panel p)
    {
        super(p);
        this.p = p;
        type = type_monster;
        ...
        defense = 1;
        exp = 3;
        projectile = new ObjectGrassBall(p);
    ...
    {
        up1 = setup("/monsters/grasshead1", p.tileSize, p.tileSize);
        up2 = setup("/monsters/grasshead2", p.tileSize, p.tileSize);
        down1 = setup("/monsters/grasshead1", p.tileSize, p.tileSize);
        down2 = setup("/monsters/grasshead2", p.tileSize, p.tileSize);
        left1 = setup("/monsters/grasshead1", p.tileSize, p.tileSize);
        left2 = setup("/monsters/grasshead2", p.tileSize, p.tileSize);
        right1 = setup("/monsters/grasshead1", p.tileSize, p.tileSize);
        right2 = setup("/monsters/grasshead2", p.tileSize, p.tileSize);
