...
public class MON_Thunder extends Entity
{
    Panel p;
    public MON_Thunder(Panel p)
    {
        ...
        projectile = new ObjectLightningBall(p);
    ...
    {
        up1 = setup("/monsters/thunderhead1", p.tileSize, p.tileSize);
        up2 = setup("/monsters/thunderhead2", p.tileSize, p.tileSize);
        down1 = setup("/monsters/thunderhead1", p.tileSize, p.tileSize);
        down2 = setup("/monsters/thunderhead2", p.tileSize, p.tileSize);
        left1 = setup("/monsters/thunderhead1", p.tileSize, p.tileSize);
        left2 = setup("/monsters/thunderhead2", p.tileSize, p.tileSize);
        right1 = setup("/monsters/thunderhead1", p.tileSize, p.tileSize);
        right2 = setup("/monsters/thunderhead2", p.tileSize, p.tileSize);
